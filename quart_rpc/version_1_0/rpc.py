...
class RPC:
    ...
    def __init__(
        self,
        app_or_blueprint: t.Union[Quart, Blueprint],
        ...
        :param app_or_blueprint: Quart / Blueprint
        ...
        if not hasattr(app_or_blueprint, "add_url_rule"):
            raise TypeError(
                ...
                f"not be an instance of Quart, Quart Blueprint or be compatible with "
                "setting Quart routes."
            )
    ...
    def _register_route(
        self, route_compatible: t.Union[Quart, Blueprint], url_prefix: str
    ):
